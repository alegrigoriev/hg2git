...
def format_data(data, format_spec, error_handler=None):
	...
	elif format_spec.trim_trailing_whitespace or format_spec.fix_eol or format_spec.fix_last_eol or format_spec.retab_only:
...
def main():
	...
	for file in file_list:
		...
		if not conf.retab_only and (conf.skip_indent_format \
			and not conf.trim_trailing_whitespace and not conf.fix_eol and not conf.fix_last_eol):
				continue
